<div class="panel panel-default">
    ...
    <div id="collapse<?php echo $countDocs; ?>" class="panel-collapse collapse">
        <div class="panel-body">
            <div class="row"><div class="col-sm-2"><i>ID</i></div><div class="col-sm-10"><a href="index.php?field=id&value=<?php echo $doc['id']; ?>" title="Permalink auf diesen Datensatz" target="_blank"><?php echo $doc['id']; ?></a></div></div>
