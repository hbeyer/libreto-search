...
<a href="index.php?field=fullText&value=<?php foreach ($_GET['owner'] as $gnd) echo '&owner[]='.$gnd; ?>" class="btn btn-default" role="button" title="Suche zurücksetzen"><i class="glyphicon glyphicon-remove"></i></a>
